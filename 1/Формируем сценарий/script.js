const roles = [`Городничий`, `Аммос Федорович`, `Артемий Филиппович`, `Артемий Филиппович`, `Лука Лукич`];
...
roles.forEach(role => {
    ...
    phrases.forEach((line, j) => { // line -> каждая отдельная фраза, j -> нумерация
